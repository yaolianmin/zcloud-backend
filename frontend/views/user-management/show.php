...
<div >
    ...
    <div >
        ...
        <?=Html::beginForm('/index.php?r=user-management/show','get',['id'=>'form','class'=>'form','data'=>'myself']);?>
            ...
            <span class="input-group-addon" style="width:20%;background-color:#007DB8;color: #fff;border:1px solid #000000;" ><?=Yii::t('yii','Username')?></span>
             <?=Html::activeTextInput($model,'username_search',['class'=>'form-control username_search','placeholder'=>Yii::t('yii','Please input user name you want to Search !')]);?>
           ...
           <!--权限选项-->
            <div class="input-group  div_power">
                ...
                <?=Html::activeTextInput($model,'power_info',['class'=>'form-control','id'=>'input-power']);?>
           ...
           <!--机种选项 -->
            <div class="input-group div_device" >
                  <span class="input-group-addon" style="width:20%;background-color:#007DB8;color: #fff;border:1px solid #000000;"><?=Yii::t('yii','Device_name')?></span>
                   <?=Html::activeTextInput($model,'device_info',['class'=>'form-control','id'=>'input-device']);?>
            ...
            <div class="device_list div_device_list">
              <?=Html::activeCheckboxList($model,'device', ArrayHelper::map($device,'dev_name', 'dev_name'),['class'=>'device_list', 'style'=>'display:none;']);?>
              <div style="text-align:center;height:20px">
                <?= Html::submitButton(Yii::t('yii','Confirm'), ['class' => 'btn btn-primary','style' => 'width:15%;margin-right:4%' ]) ?>
                <?= Html::resetButton(Yii::t('yii','Cancel'), ['class' => 'btn btn-primary', 'id' => 'contact-button','style' =>'width:15%;']) ?>   
              </div>
            ...
            <div class="input-group div_project" >
                  ...
                  <?=Html::activeTextInput($model,'project_info',['class'=>'form-control','id'=>'input-project']);?>
            ...
            <div class="project_list  div_project_list" >
              <?=Html::activeCheckboxList($model,'project', ArrayHelper::map($project_for_search,'project_name','project_name'),['class'=>'project_list', 'style'=>'display:none;']);?>
              <div style="text-align:center;height:20px">
                <?= Html::submitButton(Yii::t('yii','Confirm'), ['class' => 'btn btn-primary','style' => 'width:15%;margin-right:4%' ]) ?>
                <?= Html::resetButton(Yii::t('yii','Cancel'), ['class' => 'btn btn-primary', 'id' => 'contact-button','style' =>'width:15%;']) ?>   
              </div>
...
<div class="div-apply" id="div-apply-modify" style="margin-bottom:10%;display:none;">
        <?php $form = ActiveForm::begin(['id' => 'abc-form',
              ...
              '<div class="input-group" style="width:100%;text-algin:center;margin-top:10px;margin-left:15%;">
                ...
                <!--<?= $form->field($model, 'give_device')->textInput(['maxlength' => 20,'class'=>'apply-device'])->label(Yii::t('yii','Give_device'))?>-->
                ...
                <?= Html::Button(Yii::t('yii','Delete'), ['class' => 'btn btn-primary btn-four-delete', 'style' =>'width:8%;']) ?> 
...
if(pw1 == pw2) {
document.getElementById("tishi").innerHTML="<font color='green' style='margin-left:30%'id='tishi-1'>两次密码相同</font>";
document.getElementById("submit").disabled = false;
}
else {
document.getElementById("tishi").innerHTML="<font color='red' style='margin-left:30%'id='tishi-2'>两次密码不相同,请重新输入</font>";
...
//显示当前模块
  var show = document.getElementById('show');
      show.innerHTML="<?= Yii::t('yii','UserManagement');?>";
</script>
